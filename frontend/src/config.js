...
export const API_BASE_URL = import.meta.env.VITE_API_URL || 'https://rudra-portfolio-kj4r.vercel.app/api';
...
export const IMAGE_BASE_URL = import.meta.env.VITE_API_URL ? import.meta.env.VITE_API_URL.replace('/api', '') : 'https://rudra-portfolio-kj4r.vercel.app';
